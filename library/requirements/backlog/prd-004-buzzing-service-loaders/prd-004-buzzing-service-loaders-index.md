...
- It also supersedes the boot-shell readiness surface honeycomb [`prd-068-portal-daemon-boot-shell`](../../../../../honeycomb/library/requirements/backlog/prd-068-portal-daemon-boot-shell/prd-068-portal-daemon-boot-shell-index.md) implied, now that hive is the always-on origin.
