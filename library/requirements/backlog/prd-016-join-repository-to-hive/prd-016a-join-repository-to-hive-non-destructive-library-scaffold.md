# PRD-016a: Non-Destructive Library Scaffold
...
- Installing harness assets (016b) or writing the onboarding explainer / prompt (016c).
...
- [PRD-016 index](./prd-016-join-repository-to-hive-index.md) — parent flow, dry-run + manifest + uninstall contract.
- [PRD-050: Quick Install](../../../../../honeycomb/library/requirements/completed/prd-050-quick-install-and-guided-setup/prd-050-quick-install-and-guided-setup-index.md) — the no-clobber, idempotent posture mirrored here.
- Sibling sub-PRDs: [016b harness asset provisioning](./prd-016b-join-repository-to-hive-harness-asset-provisioning.md), [016c onboarding explainer and prompt](./prd-016c-join-repository-to-hive-onboarding-explainer-and-prompt.md).
