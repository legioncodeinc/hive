...
- **Followed by** [`prd-014-projects-onboarding`](../prd-014-projects-onboarding/prd-014-projects-onboarding-index.md): the steady-state Projects page, capture gating until first bind, and cross-device import (moved from honeycomb PRD-059).
