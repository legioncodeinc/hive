# PRD-014d: Cross-Device "Import Project from Cloud"
...
- Creating new projects (014b/014c) or new workspaces (out of scope project-wide).
...
- **Import = bind-to-existing:** reuse the daemon bind route with an existing `project_id` (vs. create-inline in 014b), writing the folder→existing-project mapping to `projects.json`; the daemon sync mirrors the new device binding to the registry.
...
- [PRD-014c: Projects Page](./prd-014c-projects-onboarding-projects-page.md) — where importable (registry-only) projects surface and link from.
- [PRD-049a: Project Identity and Resolution](../../../../../honeycomb/library/requirements/completed/prd-049-multi-project-and-context-switching/prd-049a-multi-project-and-context-switching-project-identity-and-resolution.md) — the registry vs local-binding split this bridges, and the git-remote signal reused as a hint.
- [PRD-049c: Skill Isolation](../../../../../honeycomb/library/requirements/completed/prd-049-multi-project-and-context-switching/prd-049c-multi-project-and-context-switching-skill-isolation.md) — cross-project sharing rules that still apply to an imported project.
- [`src/daemon/runtime/projects/scope-enumeration-api.ts`](../../../../../honeycomb/src/daemon/runtime/projects/scope-enumeration-api.ts) · [`src/hooks/shared/project-resolver.ts`](../../../../../honeycomb/src/hooks/shared/project-resolver.ts)
