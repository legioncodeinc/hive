# PRD-008: First Browser Load Experience

> **Status:** Superseded (archived) by [PRD-003 (portal landing gate and routing)](../../backlog/prd-003-portal-landing-gate-and-routing/prd-003-portal-landing-gate-and-routing-index.md) and [PRD-004 (/buzzing service loaders)](../../backlog/prd-004-buzzing-service-loaders/prd-004-buzzing-service-loaders-index.md).
> **Provenance:** Moved from honeycomb PRD-070 (`honeycomb/library/requirements/archive/prd-070-first-browser-load-experience/`) during the fleet realignment and renumbered as hive PRD-008. Kept for reference only; no implementation happened under this scoping. Code citations use honeycomb-repo-relative paths: bare `src/*` is honeycomb's source, `doctor/src/*` is the doctor repo. Relative markdown links below reflect the original honeycomb location and are not maintained.
>
> The first browser load is now owned by hive portal: PRD-003 defines the landing gate and PRD-004 defines the /buzzing boot experience. Honeycomb no longer serves this surface; its fleet role is defined in honeycomb [PRD-071](../../../../../honeycomb/library/requirements/backlog/prd-071-service-checkin-and-sqlite-telemetry/prd-071-service-checkin-and-sqlite-telemetry-index.md).
